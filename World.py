try:
    ...
    # for Python3
    from tkinter import *   ## notice lowercase 't' in tkinter heremaster = Tk()
...
walls = [(1, 0), (1, 2), (2, 1), (0, 4),  (2, 5),  (5, 6),  (5, 3),  (5, 2),  (6, 4),  (6, 1)]
specials = [(4, 1, "red", -1), (6, 2, "green", 1), (4, 5, "red", -1), (6, 7, "red", -1),]
cell_scores = {}
